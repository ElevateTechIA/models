export const translations = {
  es: {
    ...
    wallTab: "Wall",
    wallBy: "por",
    wallComment: "Escribe un comentario...",
    wallSend: "Enviar",
    wallEmpty: "Aun no hay fotos publicadas",
    ...
    // Credits / Tokens
    creditsTitle: "Comprar Tokens",
    creditsSubtitle: "Elige el paquete perfecto para ti",
    creditsYouHave: "Tienes",
    creditsLabel: "tokens",
    creditsBuy: "Comprar",
    creditsProcessing: "Procesando...",
    creditsPerCredit: "por token",
    creditsNoPackages: "No hay paquetes disponibles en este momento.",
    creditsFooter1: "Pagos procesados de forma segura por Stripe",
    creditsFooter2: "Los tokens no caducan y puedes usarlos en cualquier momento",
    creditsInsufficient: "Sin Tokens",
    creditsInsufficientMsg: "Necesitas tokens para generar contenido. Compra un paquete para continuar.",
    creditsBuyCredits: "Comprar Tokens",
  ...
  en: {
    ...
    wallTab: "Wall",
    wallBy: "by",
    wallComment: "Write a comment...",
    wallSend: "Send",
    wallEmpty: "No published photos yet",
    ...
    // Credits / Tokens
    creditsTitle: "Buy Tokens",
    creditsSubtitle: "Choose the perfect package for you",
    creditsYouHave: "You have",
    creditsLabel: "tokens",
    creditsBuy: "Buy",
    creditsProcessing: "Processing...",
    creditsPerCredit: "per token",
    creditsNoPackages: "No packages available at this time.",
    creditsFooter1: "Payments securely processed by Stripe",
    creditsFooter2: "Tokens never expire and can be used anytime",
    creditsInsufficient: "No Tokens",
    creditsInsufficientMsg: "You need tokens to generate content. Buy a package to continue.",
    creditsBuyCredits: "Buy Tokens",
